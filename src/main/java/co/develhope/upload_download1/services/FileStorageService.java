package co.develhope.upload_download1.services;
...
/**
 * Ho creato la classe FileStorageService annotandola con Service.
 * Ho preso la variabile fileRepositoryFolder creata nell'application.properties.
 * Ho creato la logica dei metodi upload e download della foto.
 */
@Service
public class FileStorageService {
    ...
    public String upload(MultipartFile file) throws IOException {
        ...
        if(!finalFolder.isDirectory()) throw new IOException("Final folder id not a directory");
