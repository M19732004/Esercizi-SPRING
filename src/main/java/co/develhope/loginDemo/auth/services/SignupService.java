...
public class SignupService {
    ...
    public User signup(SignupDTO signupDTO) throws Exception {// SignUpDTO rappresenta in java l'oggetto body su postman
        ...
        if(userRepository.existsByEmail(signupDTO.getEmail())) throw new Exception("Email"+signupDTO.getEmail()+" already Exists");
        ...
        user.setActivationCode(UUID.randomUUID().toString());  //UUID=Universal Unique Identifier
